...
(*   - No responses, as everywhere now: the checked property is state       *)
(*     evolution; replies are projections of the state at the answering     *)
(*     instant, and the pure reads/searches are observations, not           *)
(*     transitions.                                                         *)
